...
%% Handling feasible solutions 
    ...
    f1 = chromosome(:,V+1);   % objective function values Jack
    f2 = chromosome(:,V+2);%FM
    f3=  chromosome(:,V+3);%SS
    f4 = chromosome(:,V+4);%DB
    f5=  chromosome(:,V+6);%Dunn
    f6 = chromosome(:,V+9);%RS
    f7=  chromosome(:,V+7);%CA
    f8 = chromosome(:,V+8);%RI
    f9=  chromosome(:,V+9);%AR
    %f10 = chromosome(:,V+10);
    %f11=  chromosome(:,V+11);
    %f12 = chromosome(:,V+12);
    %f13=  chromosome(:,V+13);
...
% First front
for p=1:pop_size1
    struct(p).sp=find(((f1(p)-f1)>0 &(f2(p)-f2)>0 & (f3(p)-f3)>0 & (f4(p)-f4)<0 &(f5(p)-f5)>0 &(f6(p)-f6)>0 &(f7(p)-f7)>0 & (f8(p)-f8)>0) | ((f2(p)-f2)==0 &(f1(p)-f1)>0) | ((f1(p)-f1)==0 &(f2(p)-f2)>0)| ((f3(p)-f3)==0 &(f1(p)-f1)>0) | ((f1(p)-f1)==0 &(f3(p)-f3)>0)| ((f4(p)-f4)==0 &(f1(p)-f1)<0) | ((f1(p)-f1)==0 &(f4(p)-f4)<0)| ((f5(p)-f5)==0 &(f1(p)-f1)>0) | ((f1(p)-f1)==0 &(f5(p)-f5)>0)| ((f6(p)-f6)==0 &(f1(p)-f1)>0) | ((f1(p)-f1)==0 &(f6(p)-f6)>0)| ((f7(p)-f7)==0 &(f1(p)-f1)>0) | ((f1(p)-f1)==0 &(f8(p)-f8)>0)| ((f2(p)-f2)==0 &(f1(p)-f1)>0) | ((f1(p)-f1)==0 &(f8(p)-f8)>0)| ((f3(p)-f3)==0 &(f2(p)-f2)>0) | ((f2(p)-f2)==0 &(f3(p)-f3)>0)| ((f4(p)-f4)==0 &(f2(p)-f2)>0) | ((f2(p)-f2)==0 &(f4(p)-f4)>0)| ((f5(p)-f5)==0 &(f2(p)-f2)>0) | ((f2(p)-f2)==0 &(f5(p)-f5)>0)| ((f6(p)-f6)==0 &(f2(p)-f2)>0) | ((f2(p)-f2)==0 &(f6(p)-f6)>0)| ((f7(p)-f7)==0 &(f2(p)-f2)>0) | ((f2(p)-f2)==0 &(f7(p)-f7)>0)| ((f8(p)-f8)==0 &(f2(p)-f2)>0) | ((f2(p)-f2)==0 &(f8(p)-f8)>0)| ((f4(p)-f4)==0 &(f3(p)-f3)>0) | ((f3(p)-f3)==0 &(f4(p)-f4)>0)| ((f5(p)-f5)==0 &(f3(p)-f3)>0) | ((f3(p)-f3)==0 &(f5(p)-f5)>0)| ((f6(p)-f6)==0 &(f3(p)-f3)>0) | ((f3(p)-f3)==0 &(f6(p)-f6)>0)| ((f7(p)-f7)==0 &(f3(p)-f3)>0) | ((f3(p)-f3)==0 &(f7(p)-f7)>0)| ((f8(p)-f8)==0 &(f3(p)-f3)>0) | ((f3(p)-f3)==0 &(f8(p)-f8)>0)| ((f5(p)-f5)==0 &(f4(p)-f4)>0) | ((f4(p)-f4)==0 &(f5(p)-f5)>0)| ((f6(p)-f6)==0 &(f4(p)-f4)>0) | ((f4(p)-f4)==0 &(f6(p)-f6)>0)| ((f7(p)-f7)==0 &(f4(p)-f4)>0) | ((f4(p)-f4)==0 &(f7(p)-f7)>0)| ((f8(p)-f8)==0 &(f4(p)-f4)>0) | ((f4(p)-f4)==0 &(f8(p)-f8)>0)| ((f6(p)-f6)==0 &(f5(p)-f5)>0) | ((f6(p)-f6)==0 &(f5(p)-f5)>0)| ((f7(p)-f7)==0 &(f5(p)-f5)>0) | ((f5(p)-f5)==0 &(f7(p)-f7)>0)| ((f8(p)-f8)==0 &(f5(p)-f5)>0) | ((f5(p)-f5)==0 &(f8(p)-f8)>0)| ((f7(p)-f7)==0 &(f6(p)-f6)>0) | ((f6(p)-f6)==0 &(f7(p)-f7)>0)| ((f8(p)-f8)==0 &(f6(p)-f6)>0) | ((f6(p)-f6)==0 &(f8(p)-f8)>0)| ((f8(p)-f8)==0 &(f7(p)-f7)>0) | ((f7(p)-f7)==0 &(f8(p)-f8)>0)); 
    n(p)=length(find(((f1(p)-f1)<0 &(f2(p)-f2)<0 & (f3(p)-f3)<0 & (f4(p)-f4)>0 &(f5(p)-f5)<0 &(f6(p)-f6)<0 &(f7(p)-f7)<0 & (f8(p)-f8)<0) | ((f2(p)-f2)==0 &(f1(p)-f1)<0) | ((f1(p)-f1)==0 &(f2(p)-f2)<0)| ((f3(p)-f3)==0 &(f1(p)-f1)<0) | ((f1(p)-f1)==0 &(f3(p)-f3)<0)| ((f4(p)-f4)==0 &(f1(p)-f1)>0) | ((f1(p)-f1)==0 &(f4(p)-f4)>0)| ((f5(p)-f5)==0 &(f1(p)-f1)<0) | ((f1(p)-f1)==0 &(f5(p)-f5)<0)| ((f6(p)-f6)==0 &(f1(p)-f1)<0) | ((f1(p)-f1)==0 &(f6(p)-f6)<0)| ((f7(p)-f7)==0 &(f1(p)-f1)<0) | ((f1(p)-f1)==0 &(f8(p)-f8)<0)| ((f2(p)-f2)==0 &(f1(p)-f1)<0) | ((f1(p)-f1)==0 &(f8(p)-f8)<0)| ((f3(p)-f3)==0 &(f2(p)-f2)<0) | ((f2(p)-f2)==0 &(f3(p)-f3),0)| ((f4(p)-f4)==0 &(f2(p)-f2)<0) | ((f2(p)-f2)==0 &(f4(p)-f4)<0)| ((f5(p)-f5)==0 &(f2(p)-f2)<0) | ((f2(p)-f2)==0 &(f5(p)-f5)<0)| ((f6(p)-f6)==0 &(f2(p)-f2)<0) | ((f2(p)-f2)==0 &(f6(p)-f6)<0)| ((f7(p)-f7)==0 &(f2(p)-f2)<0) | ((f2(p)-f2)==0 &(f7(p)-f7)<0)| ((f8(p)-f8)==0 &(f2(p)-f2)<0) | ((f2(p)-f2)==0 &(f8(p)-f8)<0)| ((f4(p)-f4)==0 &(f3(p)-f3)<0) | ((f3(p)-f3)==0 &(f4(p)-f4)<0)| ((f5(p)-f5)==0 &(f3(p)-f3)<0) | ((f3(p)-f3)==0 &(f5(p)-f5)<0)| ((f6(p)-f6)==0 &(f3(p)-f3)<0) | ((f3(p)-f3)==0 &(f6(p)-f6)<0)| ((f7(p)-f7)==0 &(f3(p)-f3)<0) | ((f3(p)-f3)==0 &(f7(p)-f7)<0)| ((f8(p)-f8)==0 &(f3(p)-f3)<0) | ((f3(p)-f3)==0 &(f8(p)-f8)<0)| ((f5(p)-f5)==0 &(f4(p)-f4)<0) | ((f4(p)-f4)==0 &(f5(p)-f5)<0)| ((f6(p)-f6)==0 &(f4(p)-f4)<0) | ((f4(p)-f4)==0 &(f6(p)-f6)<0)| ((f7(p)-f7)==0 &(f4(p)-f4)<0) | ((f4(p)-f4)==0 &(f7(p)-f7)<0)| ((f8(p)-f8)==0 &(f4(p)-f4)<0) | ((f4(p)-f4)==0 &(f8(p)-f8)<0)| ((f6(p)-f6)==0 &(f5(p)-f5)<0) | ((f6(p)-f6)==0 &(f5(p)-f5)<0)| ((f7(p)-f7)==0 &(f5(p)-f5)<0) | ((f5(p)-f5)==0 &(f7(p)-f7)<0)| ((f8(p)-f8)==0 &(f5(p)-f5)<0) | ((f5(p)-f5)==0 &(f8(p)-f8)<0)| ((f7(p)-f7)==0 &(f6(p)-f6)<0) | ((f6(p)-f6)==0 &(f7(p)-f7)<0)| ((f8(p)-f8)==0 &(f6(p)-f6)<0) | ((f6(p)-f6)==0 &(f8(p)-f8)<0)| ((f8(p)-f8)==0 &(f7(p)-f7)<0) | ((f7(p)-f7)==0 &(f8(p)-f8)<0)); 
end
