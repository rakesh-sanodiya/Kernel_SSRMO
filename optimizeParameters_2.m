function [ln_sigma,ln_theta,ln_alpha] = optimizeParameters_2(traindata,trainlabel,uldata,label_index,unlabel_index,Laplacian,m_theta,Cov_theta,ln_sigma,ln_theta,ln_alpha)
    ...
    for t=1:m
        ...
        [ln_alpha(t),ln_theta(:,t)]=optimizeParameters_2_sub(traindata(index1,:),trainlabel(index1),uldata(index2,:),Laplacian{t},m_theta,Cov_theta,ln_sigma,ln_theta(:,t),ln_alpha(t));
        clear index1 index2;
    end
